    ...
    return (
        <div className="flex items-center justify-between flex-1 flex-col border-edge border h-full overflow-hidden bg-accent dark:bg-accent/50">
            ...
            <div className="p-0.5 pt-0 flex-1 h-full rounded-md flex w-full">
                <a className="flex-1 px-3 py-2 flex flex-col bg-background outline outline-muted/50 rounded-sm relative overflow-hidden group w-full"
...
function BookCover() {
    return (
        <div className="relative aspect-video h-full w-96 translate-x-[-30%] sm:translate-x-0 group-hover:translate-x-[-16%] scale-[0.45] sm:scale-100 group-hover:scale-[0.45] translate-y-[-35%] sm:translate-y-0 group-hover:translate-y-[-40%] -rotate-6 sm:rotate-0 group-hover:rotate-6 transition-transform duration-300">
